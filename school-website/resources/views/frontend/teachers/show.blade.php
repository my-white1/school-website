    ...
    <section class="pager-section">
        <div class="container">
            <div class="pager-content text-center">
                ...
                <ul>
                    <li><a href="teacher-single.html#" title="">Home</a></li>
                    <li><a href="teacher-single.html#" title="">Classes</a></li>
    ...
    <section class="page-content">
        <div class="container">
            <div class="teacher-single-page">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="teacher-coly"><img src="assets/img/tech1.jpg" alt="">
                            <ul class="social-icons">
                                <li><a href="teacher-single.html#" title=""><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="teacher-single.html#" title=""><i class="fab fa-twitter"></i></a></li>
                                <li><a href="teacher-single.html#" title=""><i class="fab fa-linkedin-in"></i></a>
                                </li>
                            </ul>
                        </div>
                        <!--teacher-coly end-->
                    ...
                    <div class="col-lg-8">
                        <div class="teacher-content">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="rol-z"><img src="assets/img/ro1.png" alt="">
                                        <div class="rol-info">
                                            <h3>Phone</h3><span>+2 342 5446 67</span>
                                        </div>
                                    </div>
                                    <!--rol-z end-->
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="rol-z style2"><img src="assets/img/ro3.png" alt="">
                                        <div class="rol-info">
                                            <h3><a href="teacher-single.html#" title="">Call Teacher<br>Now</a></h3>
                                        </div>
                                    </div>
                                    <!--rol-z end-->
                                </div>
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel venenatis felis. Fusce id
                                lectus
                                sit amet nisi ornare ultricies. In sagittis lacinia lorem et tristique. Quisque mauris
                                neque,
                                sollicitudin sit amet imperdiet in, scelerisque sit amet arcu. In vehicula sem eget nisi
                                convallis, a
                                mattis orci imperdiet. Curabitur vitae sapien vel lectus sagittis consequat. Nullam enim
                                velit,
                            ...
                            <div class="skills-tech">
                                ...
                                <div class="progess-row">
                                    <h3>Teaching</h3>
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLeft bg-clr1" data-wow-duration="1000ms"
                                ...
                                <div class="progess-row">
                                    <h3>Speaking</h3>
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLeft bg-clr2" role="progressbar"
                                ...
                                <div class="progess-row">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLeft bg-clr3" role="progressbar"
                                ...
                                <div class="progess-row">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLeft bg-clr4" role="progressbar"
                            ...
                            <!--skills-tech end-->
                            <p>Quisque congue ultrices nibh, id consectetur velit consectetur ut. Suspendisse porttitor
                                vulputate
                                imperdiet. Proin rhoncus, mauris sit amet consectetur laoreet, mauris mi volutpat urna, at
                                molestie
                                urna libero quis leo. Pellentesque ut molestie nisi. Suspendisse ut nulla eleifend ligula
                                vulputate
                                tincidunt sed eget orci.</p>
                            <p>Pellentesque aliquam varius malesuada. Proin id massa vitae eros elementum egestas id sit
                                amet elit.
                                Praesent convallis ligula ac urna rhoncus euismod. Vestibulum maximus luctus magna, in
                                sollicitudin
                                lorem tincidunt id. Nunc aliquam nibh sagittis nibh luctus blandit. Quisque nec dignissim
                                metus.
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-6 full-wdth">
                            <div class="teacher">
                                <div class="teacher-img"><img src="assets/img/img5.jpg" alt="" class="w-100">
                                    <div class="sc-div">
                                        <ul>
                                            <li><a href="teacher-single.html#" title=""><i
