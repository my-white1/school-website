                        ...
                        <table class="table table-hover my-0">
                            ...
                            @else
                                ...
                                @foreach($about->teachers as $deg)
                                    ...
                                    @if(!count($deg->degrees->ToArray())==0)

                                        <tr>
                                            {{--                                            @dd($deg->degrees[0]->id)--}}
                                            <td>{{$deg->degrees[0]->id}}</td>
                                            <td>{{$deg->firstname}} {{$deg->lastname}}</td>
                                            <td>{{\App\Models\Degree::TYPES[$deg->degrees[0]->type_id]}}</td>
                                            <td>{{$deg->degrees[0]->year}} yil</td>
